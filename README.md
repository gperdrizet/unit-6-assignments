...
The purpose of this benchmark is to show what is practically possible with two common tiers of GPU hardware: 

- Consumer card with <8 GB VRAM (GTX 1070, 8 GB ~$75 on Ebay March 2026>)
...
Each (model, mode) pair is run for 3 timed replicates at 512×512 on the prompt `"a turtle and a bird together in a forest"`. See the full results, per-hardware breakdowns, and generated images on the [GitHub Pages site](https://gperdrizet.github.io/unit-6-assignments).
